...
export default function Section2(){
    return (
        <section className="min-h-[880px] flex items-center justify-center">
            <div className="aspect-square h-[500px] bg-purple-500 relative scale-[30%] md:scale-50 lg:scale-100">
                ...
                <div className="flex flex-col absolute w-[15%] -right-9 -bottom-9 gap-8">
                    {/* Kółka mają gradient */}
                    <div className="aspect-square bg-purple-700 rounded-full text-white flex justify-center items-center">
                    ...
                    <div className="aspect-square bg-purple-700 rounded-full text-white flex justify-center items-center"><CircleDot size={32} /></div>
                    <div className="aspect-square bg-purple-700 rounded-full text-white flex justify-center items-center"><Share2 size={32} /></div>
                </div>
