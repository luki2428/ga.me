...
export default function Section2() {
  return (
    <section className="md:pt-36 md:pb-72 flex items-center justify-center">
      <div className="aspect-square h-[500px] bg-purple-500 relative scale-[35%] md:scale-50 lg:scale-100">
        <Image
          src={img1}
          alt=""
        ...
        <div className="uppercase absolute text-[80px] leading-[80px] w-72 font-bold -right-36 -top-11">
          Bądź Na Bieżąco
        </div>
        ...
        <div className="absolute -left-36 -bottom-52 w-80 flex flex-col gap-5">
          <div className="uppercase text-[80px] font-bold leading-[80px]">
            Zbuduj Swoją Listę
          </div>
          <div className="text-gray-300 font-open-sans">
            Stwórz swoją listę gier, oznaczaj ograne tytuły i udostępnij swoją
            bibliotekę. Bądź na bieżąco w świecie gier.
          </div>
          {/* Też dodać gradient do strzałki*/}
          <div>
            <Link href={"#"} className="font-bold w-auto hover:underline">
              Dołącz do nas
              <MoveRight className="text-purple-500 inline-block ml-4" />
            </Link>
          </div>
        </div>
      </div>
