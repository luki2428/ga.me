...
export default function Section6(){
    return(
        <section className="py-96 mt-32 h-[700px] flex flex-col items-center justify-center gap-14 overflow-hidden relative -z-20">
            ...
            <h1 className="uppercase font-bold text-7xl max-w-[620px] text-wrap text-center">Dołącz do społeczności</h1>
